...
const faqData = [{
    ...
    response: "Minuman favorit saya adalah thai tea [haus]."
}, {
    ...
    keywords: ["kamu siapa", "anda siapa", "lu siapa", "siapa pembuat kamu", "siapa yang buat kamu"],
    response: "saya adalah chat AI yang di buat dan di kembangkan oleh syafiq"
}, {
    keywords: ["syafiq"],
    response: "ya? apakah ada yang bisa saya bantu?"
}, {
    ...
    keywords: ["rekomendasi restoran", "tempat makan enak", "restoran favorit"],
